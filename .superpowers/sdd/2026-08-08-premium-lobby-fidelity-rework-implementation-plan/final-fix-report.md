...
## Authorized deterministic trim resolution

The accepted PixelLab sources were post-processed only by lossless RGBA alpha-bound trimming: `difficulty_selected` job `247e3be7-b2dd-4e4e-92c4-c234a21c929e`, `difficulty_idle` `af2933dc-7f5b-4d50-9fd6-35393801b918`, `primary_red_button` `f035552f-d830-4b4c-953f-41e746f102b7`, `secondary_dark_button` `9d92d471-19c7-4e6a-bef1-b3059556d5d0`, and `thin_outer_frame` `3d2ea068-ac76-4133-9f85-22d458d85aed`. Trim bounds (left,bottom,right,top in source pixel coordinates) were `(75,74,262,149)`, `(112,259,487,411)`, `(194,168,562,280)`, `(109,64,275,129)`, and `(21,23,362,665)` respectively. `difficulty_selected` had one disconnected, visually meaningless alpha pixel at `(599,0)` removed under explicit authorization; all primary connected artwork pixels were preserved. `tab_idle` now contains the same clean trimmed secondary-frame pixels, retaining its filename/GUID and semantic role.

Importer rerun logged success. Asset contract passed 18/18; production rebuild passed; full EditMode passed 923/923; full PlayMode passed 321/321. The six required native captures were regenerated and inspected: filled difficulty/action controls, selected/idle distinction, thin content/pause framing, contained lock slash, and no architectural rail were accepted.
