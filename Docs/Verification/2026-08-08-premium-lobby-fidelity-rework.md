...
## Final trim and acceptance

An authorized lossless alpha-bound trim of the accepted PixelLab originals resolved the padded controls; `tab_idle` reuses the clean trimmed secondary-frame content. Importer contracts passed 18/18, rebuild passed, full EditMode passed 923/923, and full PlayMode passed 321/321. All six required original-resolution captures were regenerated and inspected; controls fill their assigned rectangles, the active content/pause frames are thin and bounded, and no oversized architectural rail remains.
