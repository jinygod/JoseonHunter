...
namespace JoseonHunter.Tests.PlayMode
{
    internal static class EvolvedExecutorFactory
    {
        public static IWeaponExecutor CreateForTests(WeaponId weaponId, WeaponRuntimeController runtime)
        {
            ...
            if (weaponId.Equals(WeaponId.HwandoFlyingBlade)) return new FlyingBladeExecutor(runtime, baseDamage, singleCastCooldownSeconds, range, speed, 5, evolved: true);
            ...
            if (weaponId.Equals(WeaponId.FrostFlask)) return new FrostFlaskExecutor(runtime, baseDamage, singleCastCooldownSeconds, range, 0.5f, 1f, 1.4f, 4, 5, evolved: true);
